...
def compare_sales_vs_target(df):
    ...
    if not os.path.exists(target_path):
        print("Warning: Sales Target.csv not found in /data folder. Skipping target comparison.")
        return None
...
def save_outputs(monthly_df, sales_vs_target_df):
    ...
    # Save monthly sales vs target if available
    if sales_vs_target_df is not None:
        ...
        print("Skipping monthly sales vs target output because target data is unavailable.")
